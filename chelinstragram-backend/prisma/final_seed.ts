...
async function main() {
  ...
  const me = await prisma.user.create({
    data: {
      ...
      avatarUrl: '/uploads/1768777393229-428295616.jpg'
    }
  });
  const official = await prisma.user.upsert({
    ...
    create: {
      ...
      avatarUrl: '/uploads/1769111734140-735745559.png'
    },
  });
  ...
  const graciela = await prisma.user.upsert({
    ...
    create: {
      ...
      avatarUrl: '/uploads/1768777259235-930616418.jpg'
    },
  });
...
😝😝😝`,
  ...
  console.log("✅ Final Seed Successfully Executed on the Server!");
}
